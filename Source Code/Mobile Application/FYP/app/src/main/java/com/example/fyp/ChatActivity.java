...
import com.example.fyp.Fragments.APIService;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fname = findViewById(R.id.fnameData);
        lname = findViewById(R.id.lnameData);
        ...
        profile_image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentToProfile = new Intent(ChatActivity.this, ViewProfileActivity.class);
    ...
    private void sendMessage (final String sender, final String receiver, String message){
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                User user = dataSnapshot.getValue(User.class);
                if (notify){
                    sendNotification(receiver, user.getFirst_name(), msg);
                }
    ...
    private void sendNotification(String receiver, final String firstname, final String message){
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    Data data = new Data(fuser.getUid(), R.mipmap.ic_launcher,firstname+": "+message, "New Message", userid);
